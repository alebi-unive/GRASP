...
train_set = LaplacianDatasetNX(datasetname, 'data/' + datasetname, point_dim=args.k,
                               smallest=args.smallest, split='train')
...
print(f"Generated {n_graphs} graphs in {end - start} seconds")
